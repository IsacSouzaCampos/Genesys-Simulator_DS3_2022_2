...
extern \"C\" void initBetweenReplications_" + name + "(Model* model) {\n\
	...
	if (resultAll) {
		...
		std::string objectFiles = "../../build/kernel/simulator/*.o ../../build/kernel/util/*.o ../../build/kernel/statistics/*.o ../../build/parser/*.o ../../build/applications/genesysTerminalApplications/*.o ../../build/plugins/components/*.o ../../build/plugins/dataElements/*.o";
